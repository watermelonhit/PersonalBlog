webpackJsonp([0], {
    "8spK": function (t, e) {
        ...
        var r = n("VU/8")(i, a, !1, function (t) {
            n("XG1x")
        }, "data-v-68a82743", null).exports, s = {
        ...
        "use strict";
        e.a = function () {
            return Object(i.a)({url: "/api/tags", method: "get"})
        }, e.b = function () {
            return Object(i.a)({url: "/api/tags/detail", method: "get"})
        }, e.c = function () {
            return Object(i.a)({url: "/api/tags/hot", method: "get"})
        }, e.d = function (t) {
            return Object(i.a)({url: "/api/tags/detail/" + t, method: "get"})
        };
        var i = n("OOvn")
    }, nR5K: function (t, e) {
    }, s8Ph: function (t, e, n) {
        "use strict";
        e.a = function () {
            return Object(i.a)({url: "/api/categorys", method: "get"})
        }, e.b = function () {
            return Object(i.a)({url: "/api/categorys/detail", method: "get"})
        }, e.c = function (t) {
            return Object(i.a)({url: "/api/categorys/detail/" + t, method: "get"})
        };
        var i = n("OOvn")
    }, viA7: function (t, e, n) {
        "use strict";
        e.b = function (t, e) {
            ...
            return Object(i.a)({url: "/api/articles/hot", method: "post"})
        }, e.f = function () {
            return Object(i.a)({url: "/api/articles/new", method: "post"})
        }, e.i = function (t) {
            return Object(i.a)({url: "/api/articles/view/" + t, method: "post"})
        }, e.c = function (t) {
            return Object(i.a)({url: "/api/articles/category/" + t, method: "post"})
        }, e.d = function (t) {
            return Object(i.a)({url: "/api/articles/tag/" + t, method: "post"})
        }, e.h = function (t, e) {
            return Object(i.a)({headers: {Authorization: e}, url: "/api/articles/publish", method: "post", data: t})
        }, e.g = function () {
            return Object(i.a)({url: "/api/articles/listArchives", method: "post"})
        }, e.a = function (t) {
            return Object(i.a)({url: "/api/articles/" + t, method: "post"})
        };
        var i = n("OOvn")
    }
});
//# sourceMappingURL=0.f440d2bf09ad19ba3b8c.js.map